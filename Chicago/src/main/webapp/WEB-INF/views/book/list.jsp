				...
				<div class="col-md-3">
					<ul class="list-group sidebar-nav" id="sidebar-nav">
						...
						<li class="list-group-item list-toggle"><a
							href="#collapse-typography"><spring:message code="book.cate1" /></a>
						</li>
						<!-- 카테고리2 -->
						<li class="list-group-item list-toggle"><a
							href="#collapse-typography"><spring:message code="book.cate2" /></a>
						</li>
						<!-- 카테고리3 -->
						<li class="list-group-item list-toggle"><a
							href="#collapse-typography"><spring:message code="book.cate3" /></a>
						</li>
						<!-- 카테고리4 -->
						<li class="list-group-item list-toggle"><a
							href="#collapse-typography"><spring:message code="book.cate4" /></a>
						</li>
					</ul>
				</div>
				<!-- 좌측 카테고리 끝 -->
				...
				<div class="col-md-9">
					...
					<div class="tabs alternative">
						<ul class="nav nav-tabs">
							...
							<li>
								<a href="#sample-2d" data-toggle="tab">
							...
							<div class="tab-pane fade in active" id="sample-2a">
								<div class="row">
									...
									<div class="desdiv">
										<h3>${vo.book_name }</h3>
										<%-- <p>${vo.book_content }</p> --%>
										<h5><b>[저자]</b> ${vo.writer }&nbsp;&nbsp; <b>[출판사]</b> ${vo.publisher }&nbsp;&nbsp;<b>[출판일]</b> <fmt:formatDate value="${vo.publication }" pattern="yyyy년 M월 d일"/>&nbsp;&nbsp;<b>[가격]</b> ${vo.price }원&nbsp;&nbsp;</h5>
										<p>${vo.book_content }</p>
									</div>
									<br/>
									</c:forEach>
